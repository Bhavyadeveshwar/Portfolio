// src/components/ui/hero-parallax.jsx
...
export const HeroParallax = ({ products }) => {
  ...
  const translateX = useSpring(useTransform(scrollYProgress, [0, 1], [0, 999]), springConfig);
  const translateXReverse = useSpring(useTransform(scrollYProgress, [0, 1], [0, 500]), springConfig);

  return (
    <div ref={ref} className="h-[200vh] py-40 overflow-hidden relative flex flex-col">
      <Header />
...
const ProductCard = ({ product, translate }) => (
  ...
  > 
     ...
     <a href={product.link} className="block overflow-hidden rounded-lg shadow-lg">
      <img
    ...
    <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 text-white p-2 rounded-md">
      {product.title}
    </div>
  </motion.div>
);
